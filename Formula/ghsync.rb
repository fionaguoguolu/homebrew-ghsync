class Ghsync < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/fionaguoguolu/ghsync/releases/download/v0.0.3/ghsync-darwin-amd64"
      sha256 "db0008f006842e4365abf41e7bc1681a1129660224ecfe37965d5682792e00d1"
    end
    if Hardware::CPU.arm?
      url "https://github.com/fionaguoguolu/ghsync/releases/download/v0.0.3/ghsync-darwin-arm64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/fionaguoguolu/ghsync/releases/download/v0.0.3/ghsync-linux-amd64"
      sha256 "806fd1f0c5c8dd70b41786329ae53a7d15da9e6d562dd5fe0147e79faea82dbf"
    end
    if Hardware::CPU.arm?
      url "https://github.com/fionaguoguolu/ghsync/releases/download/v0.0.3/ghsync-linux-arm64"
